...
from openai.types.chat import chat_completion, chat_completion_message_function_tool_call
...
ToolCall = chat.ChatCompletionMessageToolCall
FunctionCall = chat_completion_message_function_tool_call.Function
ToolCallOutput = chat.ChatCompletionToolMessageParam
...
def dict_to_message(**message: Any) -> Message:
    ...
    Args:
        **message: The dictionary to convert.
